...
<body>
	...
	<form method="POST" action="#">
		<table border=0 align="center">
			...
			<tr>
				<td colspan="2" align="center"><button class="btn btn-block" name="submit">Tạo Chapter</button></td>
			</tr>
