...
<body>
    ...
    <div class="container-fluid" style="margin-top:10px;margin-left:90px;margin-right:450px;">
     <h1>Chúc mừng bạn!!</h1>
     <br><br> <p>Bạn đã hoàn thành kiểm tra HTML để nhận chứng chỉ, hãy nhấp vào bên dưới.</p><br>
	<button type="submit" class="btn btn-primary" name="submit">Nhận chứng chỉ ngay bây giờ</button>
	</div>
	</form>
<br>
	<?php
